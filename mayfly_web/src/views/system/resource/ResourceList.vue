<template>
    <div class="menu">
        <div class="toolbar">
            <div>
                <span style="font-size: 14px"> <i class="info"></i>红色字体表示禁用状态,右击鼠标显示操作 </span>
            </div>
                    ...
                    <el-dropdown trigger="contextmenu">
                        <span class="el-dropdown-link">
                            <span style="font-size: 13px" v-if="data.type === enums.ResourceTypeEnum.MENU.value">
                                ...
                                {{ data.name }}
                                <span style="color: #3c8dbc">】</span>
                                <el-tag v-if="data.children">{{ data.children.length }}</el-tag>
                            </span>
                        ...
                        <template #dropdown>
                            <el-dropdown-menu>
                                <el-dropdown-item>
                                    <el-link @click.prevent="info(data)" icon="view" type="info" :underline="false">查看</el-link>
                                </el-dropdown-item>
                                <el-dropdown-item>
                                    <el-link
                                ...
                                <el-dropdown-item v-if="data.type === enums.ResourceTypeEnum.MENU.value">
                                    <el-link v-auth="'resource:add'" @click.prevent="addResource(data)" icon="plus" :underline="false" type="success">
                                        新增
                                    </el-link>
                                </el-dropdown-item>
                                <el-dropdown-item v-if="data.status === 1 && data.type === enums.ResourceTypeEnum.PERMISSION.value">
                                    <el-link
                                        v-auth="'resource:changeStatus'"
                                        @click.prevent="changeStatus(data, 0)"
                                        icon="circle-close"
                                        :underline="false"
                                        type="warning"
                                    >
                                ...
                                <el-dropdown-item v-if="data.status === 0 && data.type === enums.ResourceTypeEnum.PERMISSION.value">
                                    <el-link
                                        v-auth="'resource:changeStatus'"
                                ...
                                <el-dropdown-item v-if="data.children == null && data.name !== '首页'">
                                    <el-link
                                        v-auth="'resource:del'"
